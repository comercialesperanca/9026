...
uses
  ...
  cxLookAndFeelPainters, cxContainer, cxEdit, cxTextEdit, cxMemo, dxSkinsCore, dxSkinBlack, dxSkinBlue, dxSkinBlueprint, dxSkinCaramel, dxSkinCoffee,
...
procedure TfrmMensagens.btOKClick(Sender: TObject);
begin
  frmMensagens.Close;
end;
